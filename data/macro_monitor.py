...
class MacroDataProvider:
    ...
    def _apply_yield_update(self, latest_yield: float) -> float:
        """Apply latest 10Y yield update into cache and return bps delta."""
        with self._lock:
    ...
    def _fetch_live_data(self) -> None:
        try:
            ...
            chg_bps = self._apply_yield_update(latest_yield)
